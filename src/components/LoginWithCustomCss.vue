...
<template>
  <div class="login">
    ...
    <p>Note: For a low-effort solution, you can simply include another CSS file that overrides the existing CSS. However, this is not recommended.
        Instead, you should manually pull in the Sass files, include them in your build, and modify them as necessary.
        This involves taking full ownership over the css
        
        This example uses the simple override case</p>
  </div>
</template>
    ...
    this.$nextTick(function () {
        ...
        i18n: {
          en: {
            ...
            'mfa.sendCode' : 'Click here for a code'
          }
        },
        authParams: {
          pkce: true,
